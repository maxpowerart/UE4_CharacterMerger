...
struct FCMRefPoseOverride
{
 public:
	...
	/**
	 * Constructs a FCMRefPoseOverride.
	 */
	 ...
	 */
	void AddOverride(FName BoneName, ECMBoneOverrideMode OverrideMode = BoneOnly)
	{
 ...
 private:
	 ...
	 struct FCMBoneOverrideInfo
	 {
		 ...
		 ECMBoneOverrideMode OverrideMode;
	 };
	...
	friend class FCMSkeletalMeshMerge;
};
...
private:
	...
	*/
	...
	//void OverrideSockets(const TArray<FCMRefPoseOverride>& PoseOverrides);
